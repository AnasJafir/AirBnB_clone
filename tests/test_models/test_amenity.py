...
class TestAmenity_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        amenity_1 = Amenity()
        amenity_1.id = "777777"
        amenity_1.created_at = amenity_1.updated_at = _date
        amenity_str = amenity_1.__str__()
        self.assertIn("[Amenity] (777777)", amenity_str)
        self.assertIn("'id': '777777'", amenity_str)
        self.assertIn("'created_at': " + _date_repr, amenity_str)
        self.assertIn("'updated_at': " + _date_repr, amenity_str)
...
class TestAmenity_save(unittest.TestCase):
    ...
    def test_one_save(self):
        amenity_1 = Amenity()
        sleep(0.05)
        initial_updated_at = amenity_1.updated_at
        amenity_1.save()
        self.assertLess(initial_updated_at, amenity_1.updated_at)
