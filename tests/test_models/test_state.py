...
class TestState_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        state = State()
        state.id = "777777"
        state.created_at = state.updated_at = _date
        state_str = state.__str__()
        self.assertIn("[State] (777777)", state_str)
        self.assertIn("'id': '777777'", state_str)
        self.assertIn("'created_at': " + _date_repr, state_str)
        self.assertIn("'updated_at': " + _date_repr, state_str)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        state = State(id="345", created_at=_date_iso, updated_at=_date_iso)
        self.assertEqual(state.id, "345")
        self.assertEqual(state.created_at, _date)
        self.assertEqual(state.updated_at, _date)
